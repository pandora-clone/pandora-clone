...
getMe() {
    ...
    this.setState({
        ...
        id: response.id,
        profilePic: 'https://gaia.ub.edu/twiki/pub/Main/UserProfileHeader/default-user-profile.jpg'
    }) :
    this.setState({
        name: response.display_name,
        id: response.id,
      ...
      <div className="topNavContainer">
        ...
        {this.props.user.user_id ? 
                ...
                <div className="displayName">
                    {this.state.name != null ? <span>{this.state.name}</span> : <span>{this.state.id}</span>}
                </div>
      </div>
    );
  }
